...
data_file_path = os.path.join(data_folder, 'Testing dataset_Mencoder.csv') # Access dataset file in the Datasets folder without hardcoding the path
plot_file_path = os.path.join(plot_folder, 'Evaluation testing dataset_Mencoder.svg')
metrics_file_path = os.path.join(metrics_folder, 'Metrics testing dataset_Mencoder.xlsx')
